...
if __name__ == '__main__':
  ...
  net.data, net.label = L.Data(name='data',batch_size=32, backend=P.Data.LMDB, source='examples/imagenet/ilsvrc12_train_lmdb',
                             transform_param=dict(crop_size=227,mean_value=[127.5,127.5,127.5],scale=1/127.5),
